...
function Home() {
  return (
    <>
      <body class="leading-normal tracking-normal text-white bg-gradient-to-r from-pink-600 to-yellow-500">
        <nav id="header" class="fixed w-full z-30 top-0 text-white bg-white">
          <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            <div class="pl-4 flex items-center">
              <a
                class=" bg-white text-gray-800 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                href="/#"
              >
                <svg
        ...
        <section class="bg-white border-b py-8">
          <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="w-full mb-4">
              <div class="h-1 mx-auto bg-gradient-to-r from-pink-600 to-yellow-500 w-64 opacity-25 my-0 py-0 rounded-t"></div>
            </div>
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              ...
              <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                <div class="flex items-center justify-start">
                  <button class="mx-auto lg:mx-0 hover:underline bg-gradient-to-r from-pink-600 to-yellow-500 text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    Action
                  </button>
                </div>
              </div>
            ...
            <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
              ...
              <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
                <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                  ...
                  <div class="h-1 w-full bg-gradient-to-r from-pink-600 to-yellow-500 my-0 py-0 rounded-t"></div>
